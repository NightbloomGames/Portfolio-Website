    ...
    <section className = "flex h-screen items-center justify-center px-24">
      <div className="relative flex items-center justify-center w-full">
        ...
        <div className="relative max-w-2xl rounded-2xl border border-white/10 bg-purple-500/[0.03] backdrop-blur-md p-10">
          <p className="mb-4 text-sm tracking-[0.4em] text-purple-300 uppercase">
            Gameplay Programmer
          </p>
          ...
          <h2 className="mt-3 text-3xl text-white/70">
            Building immersive gameplay systems
          </h2>

          <p className="mt-8 max-w-xl text-lg leading-8 text-white/60">
            I'm a game development student specializing in gameplay
            programming and combat systems, with a passion for creating
            engaging and rewarding player experiences in Unreal Engine 5.
          </p>

          <div className="mt-12 flex gap-5">
            <button className="rounded-full border border-purple-400 bg-purple-500/20 px-8 py-3 transition hover:bg-purple-500/30">
              View Projects
            </button>

            <button className="rounded-full border border-white/20 px-8 py-3 transition hover:bg-white/10">
              Resume
            </button>
          </div>
